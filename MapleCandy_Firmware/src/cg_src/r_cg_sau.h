...
Macro definitions
***********************************************************************************************************************/
#define _8000_SAU0_CH0_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
#define _8000_SAU0_CH1_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
#define _8000_SAU0_CH2_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
#define _8000_SAU0_CH3_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
...
#define _8000_SAU1_CH0_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
#define _8000_SAU1_CH1_BAUDRATE_DIVISOR         (0x8000U) /* transfer clock set by dividing the operating clock */
#define _AC00_SAU1_CH2_BAUDRATE_DIVISOR         (0xAC00U) /* transfer clock set by dividing the operating clock */
#define _AC00_SAU1_CH3_BAUDRATE_DIVISOR         (0xAC00U) /* transfer clock set by dividing the operating clock */
...
#define _0020_SMR13_DEFAULT_VALUE               (0x0020U) /* SMR13 default value */
...
#define _0004_SCR13_DEFAULT_VALUE               (0x0004U) /* SCR13 default value */
