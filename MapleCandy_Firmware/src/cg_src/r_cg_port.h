...
Macro definitions
***********************************************************************************************************************/
#define _EF_PM1_DEFAULT_VALUE             (0xEFU) /* PM1 default value */
#define _34_PM2_DEFAULT_VALUE             (0x34U) /* PM2 default value */
#define _18_PM3_DEFAULT_VALUE             (0x18U) /* PM3 default value */
#define _E6_PM4_DEFAULT_VALUE             (0xE6U) /* PM4 default value */
#define _F8_PM5_DEFAULT_VALUE             (0xF8U) /* PM5 default value */
#define _FC_PM6_DEFAULT_VALUE             (0xFCU) /* PM6 default value */
#define _FC_PM8_DEFAULT_VALUE             (0xFCU) /* PM8 default value */
#define _34_PM10_DEFAULT_VALUE            (0x34U) /* PM10 default value */
...
#define _34_PMC2_DEFAULT_VALUE            (0x34U) /* PMC2 default value */
#define _FC_PMC8_DEFAULT_VALUE            (0xFCU) /* PMC8 default value */
#define _34_PMC10_DEFAULT_VALUE           (0x34U) /* PMC10 default value */
#define _F0_PMC14_DEFAULT_VALUE           (0xF0U) /* PMC14 default value */
#define _E2_PMC15_DEFAULT_VALUE           (0xE2U) /* PMC15 default value */
#define _80_PFSEG0_DEFAULT_VALUE          (0x80U) /* PFSEG0 default value */
#define _0F_PFSEG1_DEFAULT_VALUE          (0x0FU) /* PFSEG1 default value */
#define _80_PFSEG2_DEFAULT_VALUE          (0x80U) /* PFSEG2 default value */
#define _D1_PFSEG3_DEFAULT_VALUE          (0xD1U) /* PFSEG3 default value */
#define _01_PFSEG4_DEFAULT_VALUE          (0x01U) /* PFSEG4 default value */
#define _06_PFSEG5_DEFAULT_VALUE          (0x06U) /* PFSEG5 default value */
