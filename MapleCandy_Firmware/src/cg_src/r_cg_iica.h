...
#define _BC_IICA_LOW_WIDTH                            (0xBCU) /* set the low-level width (tLOW) of the SCLA0 pin signal */
#define _D4_IICA_HIGH_WIDTH                           (0xD4U) /* set the high-level width of the SCLA0 pin signal */
