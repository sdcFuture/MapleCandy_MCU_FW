...
Macro definitions
***********************************************************************************************************************/
#define _0013_TAU_TDR00_VALUE                 (0x0013U) /* 16-bit timer data register 00 */
#define _07CF_TAU_TDR01_VALUE                 (0x07CFU) /* 16-bit timer data register 01 */
#define _4E1F_TAU_TDR02_VALUE                 (0x4E1FU) /* 16-bit timer data register 02 */
#define _4E1F_TAU_TDR03_VALUE                 (0x4E1FU) /* 16-bit timer data register 03 */
#define _4E1F_TAU_TDR04_VALUE                 (0x4E1FU) /* 16-bit timer data register 04 */
